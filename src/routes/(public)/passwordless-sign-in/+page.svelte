  ...
  <div class="flex items-center justify-center p-4 mt-20 mb-12">
    ...
    >
      ...
      <p class="mb-6 text-base">
        {form?.message ?? "If your email is registered, you will receive a magic link at your email shortly."}
      </p>
    </div>
  </div>
{:else}
      ...
      >
        <form method="POST" action="" use:enhance={handle_submit}>
          ...
          >
            ...
            <a class="btn btn-outline btn-primary text-base font-bold w-full py-2" href="/sign-in">Sign In With Password</a>
          </div>
        </form>
      </div>
    </div>
