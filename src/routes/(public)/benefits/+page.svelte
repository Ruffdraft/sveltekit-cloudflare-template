...
<svelte:head>
  <title>Financial Benefits - {WEBSITE_NAME}</title>
  <meta name="description" content="Learn how {WEBSITE_NAME} can reduce infrastructure costs and maximise your return on investment." />
</svelte:head>

<div class="container mx-auto px-4 py-8">
  <article class="prose prose-slate lg:prose-xl mx-auto">
    <h1 class="font-bold mb-4">Financial Benefits</h1>
    <p class="text-lg">Why choose {WEBSITE_NAME}?</p>
    <p>
